 ...
 *
 * first add the -f flag
 * use tolower() or to upper() for the caseless string compare
 * */ 
...
main(int argc, char *argv[])
{
    ...
    if(argc > 1 && strcmp1(argv[1], "-n") == 0) 
        ...
        reverse = 1;
    else if(argc > 1 && strcmp1(argv[1], "-f") == 0)
        fold = 1;
    else if(argc > 1 && strcmp1(argv[1], "-d") == 0)
        dirorder = 1;
    ...
    if(argc > 2 && strcmp1(argv[2], "-n") == 0)
        ...
        reverse = 1;
    else if(argc > 2 && strcmp1(argv[2], "-f") == 0)
        fold = 1;
    else if(argc > 1 && strcmp1(argv[2], "-d") == 0)
        dirorder = 1;
    
    if(argc > 3 && strcmp1(argv[3], "-n") == 0)
        numeric = 1;
    else if(argc > 3 && strcmp1(argv[3], "-r") == 0)
        reverse = 1;
    else if(argc > 3 && strcmp1(argv[3], "-f") == 0)
        fold = 1;
    else if(argc > 1 && strcmp1(argv[3], "-d") == 0)
        dirorder = 1;
    
    if(argc > 4 && strcmp1(argv[4], "-n") == 0)
        numeric = 1;
    else if(argc > 4 && strcmp1(argv[4], "-r") == 0)
        reverse = 1;
    else if(argc > 4 && strcmp1(argv[4], "-f") == 0)
        fold = 1;
    else if(argc > 4 && strcmp1(argv[4], "-d") == 0)
        dirorder = 1;
...
int strcmp1(char *s, char *t)
{
    ...
    {
        for(i=0; tolower(s[i]) == tolower(t[i]); i++)    /* iterate until a difference found */
            if(s[i]=='\0')             /* no differences found */
                return 0;
        
        return tolower(s[i]) - tolower(t[i]);            /* Ascii arithmetic l-r==-6 */
    }
}
